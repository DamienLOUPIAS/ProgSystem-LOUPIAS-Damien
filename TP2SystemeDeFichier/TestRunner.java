    ...
    public static void testStep1() {
        ...
        Utils.writeInt(buffer, 20, entier);

        assert (Utils.readInt(buffer, 20) == entier) : "Etape 1 incorecte (entier)";

        
        short aMemoriser = 678;
        Utils.writeShort(buffer, 25, aMemoriser);

        assert (Utils.readShort(buffer, 25) == aMemoriser) : "Etape 1 incorecte (short)";
